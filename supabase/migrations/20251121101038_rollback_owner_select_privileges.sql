-- =====================================================
-- ROLLBACK OWNER SELECT PRIVILEGES
-- =====================================================
-- Restore simple working SELECT policies
...
-- PERMISSIONS TABLE - Simple: Users see their own permissions
...
-- WORKSPACES TABLE - Simple: Direct or inherited from org
